...
export const heroImages = [
  {
    ...
    ...img(
      ...
      HD,
      "Vista panoramica al amanecer en la sierra del norte de Mexico, similar al paisaje de Arivechi",
    ),
  },
  {
    id: "patrimonio",
    ...img(
      "mexico,colonial,church,village,facade",
      HD,
      "Templo colonial mexicano, evocando el Templo de Santa Rosalia",
    ),
  },
  {
    id: "sierra",
    ...img(
      "sierra-madre,mexico,mountain,landscape,desert",
      HD,
      "Cordillera de la Sierra Madre Occidental con vegetacion seca caracteristica",
    ),
  },
  {
    id: "tradicion",
    ...img(
      "mexico,traditional,village,colonial,plaza",
      HD,
      "Pueblo tradicional mexicano con calles empedradas y arquitectura serrana",
    ),
  },
  {
    id: "rio",
    ...img(
      "mexico,river,canyon,sierra,nature",
      HD,
      "Rio de montana recorriendo un valle entre cerros",
    ),
  },
  {
    id: "kiosco",
    ...img(
      "mexico,kiosk,plaza,park,bandstand",
      HD,
      "Kiosco morisco en una plaza historica mexicana",
    ),
  },
  {
    id: "gobierno",
    ...img(
      "mexico,government,colonial,building,palace",
      HD,
      "Edificio institucional historico mexicano, representativo de un Palacio Municipal",
    ),
  },
];
