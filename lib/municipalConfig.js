export const municipalConfig = {
  ...
  contacto: {
    direccion: 'Palacio Municipal, Plaza Principal s/n, Centro',
    cp: '85680',
    ciudad: 'Arivechi, Sonora',
    direccionCompleta: 'Palacio Municipal, Plaza Principal s/n, Centro, C.P. 85680, Arivechi, Sonora',
    telefono: '(634) XXX-XXXX',
    email: 'contacto@arivechi.gob.mx',
